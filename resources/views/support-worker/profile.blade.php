                ...
                <x-card class="p-10">
                    <div class="flex flex-col items-center justify-center text-center space-y-6">
                        ...
                        {{-- <a href="mailto:{{ $user->email }}"
                           class="inline-block bg-gray-900 text-white px-8 py-3 rounded-full hover:bg-gray-600 transition duration-300 mt-6">
                             Contact Care Seeker
                        </a> --}}
                    </div>
                </x-card>
        ...
        <section>
            <x-card class="p-10 max-w-lg mx-auto my-24">
                ...
                <form method="POST" action="/supportworker/add-profile">
                    ...
                    <div class="mb-6">
                        <button type="submit"
                            class="bg-gray-900 text-white rounded py-2 px-4 hover:bg-gray-600 block mx-auto">
                            Create Profile
                        </button>
                    </div>
                    ...
                    <div class="mb-6 text-center">
                        <a href="/"
                            class="text-lg text-gray-900 hover:text-gray-600 transition duration-300">
                            Back
                        </a>
                    </div>
                </form>
